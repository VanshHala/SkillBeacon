...
public class DashboardController {
    ...
    public DashboardResponse getDashboardMetrics() {
        ...
        return DashboardResponse.builder()
                .totalJobs(totalJobs > 0 ? totalJobs : 14250) // Mock fallback if db is empty during initial dev
                .avgSalary("₹12.5L")
                .marketVolatility(5.2)
                .aiConfidence(92.4)
                .jobsByCity(jobsByCity.isEmpty() ? List.of(Map.of("city", "Bangalore", "count", 4500)) : jobsByCity)
                .jobsByRole(
                        jobsByRole.isEmpty() ? List.of(Map.of("role", "Software Engineer", "count", 3200)) : jobsByRole)
