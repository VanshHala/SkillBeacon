...
export default function AuthPage() {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 antialiased overflow-hidden min-h-screen">
            <style>{`.mesh-gradient { background-color: #1b2021; background-image: radial-gradient(at 0% 0%, hsla(0, 0%, 100%, 0.05) 0px, transparent 50%), radial-gradient(at 100% 0%, hsla(0, 0%, 100%, 0.03) 0px, transparent 50%); } .glass-morphism { background: rgba(255, 255, 255, 0.8); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); border: 1px solid rgba(255, 255, 255, 0.5); } .cyber-border:focus-within { border-color: #1b2021; box-shadow: 0 0 0 2px rgba(27, 32, 33, 0.1); }`}</style>

            <div className="flex min-h-screen w-full">
                {/* Left Side: Abstract 3D Visualization */}
                <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden mesh-gradient items-center justify-center">
                    <div className="absolute inset-0 opacity-40 bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuB3RcH7049ryhJd5WEyw6Dh-a8nHJwuRQF1RL2lFowkziF-Lr_XhznSeLHUnfscZeYBJ0iiBIAZH77xTqDdnvZKQpYVrKxxpUgBVtyun9KJC5myDXcpv-D_auI9hP9mPuCsMmw9Duu0utfkUFZLy-qjc6RYtdkZ-wPX-Gx456iZkii11lHnuJ4OmdkyD10jr53SGdFNBlm7qMX9RbmqN_lqqOVCNW029499rIuV4mQu0F7ZUxtdLO2Lp7K4PrjIp2hmmTLtzMe3D4U")' }}></div>
